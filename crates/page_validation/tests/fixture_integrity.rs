...
fn pdf_fixtures_remain_byte_exact() {
    let fixtures: [(&str, &[u8], &str); 268] = [
        ...
        (
            ...
            include_bytes!("fixtures/pdfua1-rule-7-20-1-allowed.pdf"),
            "4193d4bda6099a6a96996dc940569a776b33b16c3d48ac8c5d655bd62c3e6bb3",
        ),
        (
            "pdfua1-rule-7-20-1-forbidden.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-20-1-forbidden.pdf"),
            "619d0dff56516074fe9529ca64ba094b89ad0fc48254b1f8abfd3b70b3f2120a",
        ),
        (
            "pdfua1-rule-7-20-2-allowed.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-20-2-allowed.pdf"),
            "0cfb57f244fc772838b77e727eb4c7098db50eb215bd86955c2532adb0f06e30",
        ),
        (
        ...
        (
            "pdfua1-rule-7-21-3-3-3-allowed.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-3-3-3-allowed.pdf"),
            "1c5894221f62bd50d3e1e3f9ccc736d419cbc3bf19b6e9423052241fe62fa46a",
        ),
        (
            "pdfua1-rule-7-21-3-3-3-embedded-unknown.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-3-3-3-embedded-unknown.pdf"),
            "082ac4ed5550f21dcdc8c21c191509a985cbd00b5b4f63e37394c74566d206e7",
        ),
        (
            "pdfua1-rule-7-21-3-3-3-dictionary-unknown.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-3-3-3-dictionary-unknown.pdf"),
            "734a5265360271aae7770eed61f5b97e395c7972771d0144f455f9272368032c",
        ),
        (
        ...
        (
            ...
            include_bytes!("fixtures/pdfua1-rule-7-21-4-2-1-complete.pdf"),
            "40ae2433208473bd5f43ead2019858c9393e7df63d2dd52c1dd479f33db7a0ad",
        ),
        (
            "pdfua1-rule-7-21-4-2-1-incomplete.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-4-2-1-incomplete.pdf"),
            "eb815fdc5f1c47ddec070c9b77ec8242b51f7091fe92d05562c53353756abcb4",
        ),
        (
            "pdfua1-rule-7-21-4-2-2-complete.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-4-2-2-complete.pdf"),
            "9702c8dd95eeac4ffd1b66f29eecd410305493f8f494ae53ff1323e4924e749e",
        ),
        (
            "pdfua1-rule-7-21-4-2-2-incomplete.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-4-2-2-incomplete.pdf"),
            "6c9ab9301bbf0440b4a6532417e2499af975cb6ef315efa66f7472fcba8b9a12",
        ),
        (
        ...
        (
            ...
            include_bytes!("fixtures/pdfua1-rule-7-21-8-1-matching.pdf"),
            "70fcc6240f5445fcbe00ed525745bd08cdd7d37c9e43aaead517cea41dff7c1b",
        ),
        (
            "pdfua1-rule-7-21-8-1-notdef.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-21-8-1-notdef.pdf"),
            "8c04d57a52d55980918cff2db079f03fdaf2ef7b3bed28e9eb4eb9ed0dd5273b",
        ),
        (
        ...
        (
            ...
            include_bytes!("fixtures/pdfua1-rule-7-18-6-2-1-allowed.pdf"),
            "f32207b3ee93f3b50125a7a7db3a9dc53d2e832901d72d83f45ba322aa9522ec",
        ),
        (
            "pdfua1-rule-7-18-6-2-1-missing-ct.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-6-2-1-missing-ct.pdf"),
            "a17f351aa25791c316a1674d6023253de133d507f0e19a5cbefd9260fe86d637",
        ),
        (
            "pdfua1-rule-7-18-6-2-2-allowed.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-6-2-2-allowed.pdf"),
            "f32207b3ee93f3b50125a7a7db3a9dc53d2e832901d72d83f45ba322aa9522ec",
        ),
        (
            "pdfua1-rule-7-18-6-2-2-invalid-alt.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-6-2-2-invalid-alt.pdf"),
            "8b3f874c3a31484432a77230b2ac28e1b81bfdd4aeb2aa7f1cdd492ade819e80",
        ),
        (
            "pdfua1-rule-7-18-6-2-2-missing-alt.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-6-2-2-missing-alt.pdf"),
            "1f3e604ca6207e4f899a7a5b8700df234340250ed89a9d29059574fa81f2e883",
        ),
        (
            "pdfua1-rule-7-18-8-1-allowed.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-8-1-allowed.pdf"),
            "eacdf9848027daa53802d326f87a16a3a35a5aeef73ce300a1d735a9f4e5b327",
        ),
        (
            "pdfua1-rule-7-18-8-1-hidden.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-8-1-hidden.pdf"),
            "3ebd202d65edcbcb5acd5dfeb5cb3906acfae14494ebc8e394c61016fdec2e4d",
        ),
        (
            "pdfua1-rule-7-18-8-1-outside-crop-box.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-8-1-outside-crop-box.pdf"),
            "177133bce7ad1f19c527307e8fdde3f30ec7d64c832f287f3939e29f175e2a36",
        ),
        (
            "pdfua1-rule-7-18-8-1-included.pdf",
            include_bytes!("fixtures/pdfua1-rule-7-18-8-1-included.pdf"),
            "fe06ee288a9097c7d46b37186296d89792aafe54f639e243fcd1e80395bbb256",
        ),
    ];
