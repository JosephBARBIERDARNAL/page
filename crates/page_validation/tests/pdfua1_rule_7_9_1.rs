...
#[test]
#[ignore = "maintenance generator for PDF/UA-1 rule 7.9-1 fixtures"]
fn regenerate_pdfua1_rule_7_9_1_fixtures() {
    for (fixture, case) in [
        ("pdfua1-rule-7-9-1-present.pdf", "present"),
        ("pdfua1-rule-7-9-1-missing.pdf", "missing"),
    ] {
        fs::write(
            Path::new("tests/fixtures").join(fixture),
            common::pdfua1_rule_7_9_1_fixture(case),
        )
        .expect("write PDF/UA-1 rule 7.9-1 fixture");
    }
}

#[test]
fn pdfua1_rule_7_9_1_fixtures_match_verapdf_1302_when_opted_in() {
    ...
    for (fixture, should_fail) in [
        ("pdfua1-rule-7-9-1-present.pdf", false),
        ("pdfua1-rule-7-9-1-missing.pdf", true),
    ] {
