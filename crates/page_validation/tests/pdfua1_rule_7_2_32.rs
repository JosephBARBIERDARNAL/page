...
#[test]
fn pdfua1_rule_7_2_32_requires_language_for_span_e_text() {
    for case in [
...
#[test]
#[ignore = "maintenance generator for PDF/UA-1 rule 7.2-32 fixtures"]
fn regenerate_pdfua1_rule_7_2_32_fixtures() {
    for case in [
        "property_language_present",
        "inherited_language_present",
        "catalog_language_present",
        ...
        fs::write(
            Path::new("tests/fixtures").join(format!("pdfua1-rule-7-2-32-{case}.pdf")),
            common::pdfua1_rule_7_2_32_fixture(case),
        )
        .expect("write PDF/UA-1 rule 7.2-32 fixture");
    }
}

#[test]
fn pdfua1_rule_7_2_32_fixtures_match_verapdf_when_opted_in() {
    ...
    for (case, should_fail) in [
        ...
        let path = Path::new(env!("CARGO_MANIFEST_DIR"))
            .join("tests/fixtures")
            .join(format!("pdfua1-rule-7-2-32-{case}.pdf"));
