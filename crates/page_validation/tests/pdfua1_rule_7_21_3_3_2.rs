...
#[test]
fn pdfua1_rule_7_21_3_3_2_requires_matching_cmap_wmodes() {
    ...
    assert_eq!(matching.checks.total, 83, "{matching}");
...
#[test]
#[ignore = "maintenance generator for PDF/UA-1 rule 7.21.3.3-2 fixtures"]
fn regenerate_pdfua1_rule_7_21_3_3_2_fixtures() {
    for (fixture, case) in [
        ("pdfua1-rule-7-21-3-3-2-matching.pdf", "matching"),
        ("pdfua1-rule-7-21-3-3-2-mismatched.pdf", "mismatched"),
    ] {
        fs::write(
            Path::new("tests/fixtures").join(fixture),
            common::pdfua1_rule_7_21_3_3_2_fixture(case),
        )
        .expect("write PDF/UA-1 rule 7.21.3.3-2 fixture");
    }
}

#[test]
fn pdfua1_rule_7_21_3_3_2_fixtures_match_verapdf_1302_when_opted_in() {
    ...
    for (fixture, should_fail) in [
        ("pdfua1-rule-7-21-3-3-2-matching.pdf", false),
        ("pdfua1-rule-7-21-3-3-2-mismatched.pdf", true),
    ] {
...
fn fixture_bytes(case: &str) -> &'static [u8] {
    match case {
        "matching" => include_bytes!("fixtures/pdfua1-rule-7-21-3-3-2-matching.pdf"),
        "mismatched" => include_bytes!("fixtures/pdfua1-rule-7-21-3-3-2-mismatched.pdf"),
