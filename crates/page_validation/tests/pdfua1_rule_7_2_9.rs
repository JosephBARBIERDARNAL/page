...
const RULE: &str = "PDFUA1-TD-PARENT-001";
const REFERENCE_RULE: &str = "ISO 14289-1:2014:7.2:9";
...
#[test]
#[ignore = "maintenance generator for PDF/UA-1 rule 7.2-9 fixtures"]
fn regenerate_pdfua1_rule_7_2_9_fixtures() {
    for (fixture, case) in [
        ("pdfua1-rule-7-2-9-contained.pdf", "contained"),
        ("pdfua1-rule-7-2-9-not-contained.pdf", "not_contained"),
    ] {
        fs::write(
            Path::new("tests/fixtures").join(fixture),
            common::pdfua1_rule_7_2_9_fixture(case),
        )
        .expect("write PDF/UA-1 rule 7.2-9 fixture");
    }
}

#[test]
fn pdfua1_rule_7_2_9_fixtures_match_verapdf_1302_when_opted_in() {
    ...
    for (fixture, should_fail) in [
        ("pdfua1-rule-7-2-9-contained.pdf", false),
        ("pdfua1-rule-7-2-9-not-contained.pdf", true),
    ] {
