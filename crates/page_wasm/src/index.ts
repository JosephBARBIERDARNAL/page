...
export class SafetyLimits implements SafetyLimitsOptions {
  ...
  static readonly DEFAULT_MAX_OBJECT_COUNT =
    DEFAULT_SAFETY_LIMITS.maxObjectCount;
  static readonly DEFAULT_MAX_REFERENCE_DEPTH =
    DEFAULT_SAFETY_LIMITS.maxReferenceDepth;
  static readonly DEFAULT_MAX_XREF_REVISIONS =
    DEFAULT_SAFETY_LIMITS.maxXrefRevisions;
