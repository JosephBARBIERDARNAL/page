...
pub const RULE_MAPPINGS: [RuleMapping; 7] = [
    RuleMapping {
    ...
    RuleMapping {
        ...
        verapdf_rule_id: Some("ISO_19005_1:6.1.3:2"),
    ...
    RuleMapping {
        ...
        verapdf_rule_id: Some("ISO_19005_1:6.7.2:1"),
        iso_clause: Some("ISO 19005-1:2005, 6.7.2"),
        strength: MappingStrength::PartialProxy,
        reference_test: Some("containsMetadata == true"),
        notes: "The local check requires a parseable XML stream but does not yet verify Metadata Type/Subtype; XMP serialization is additionally covered by reference rule 6.7.9 test 1.",
    },
    RuleMapping {
        local_rule_id: "PDFA1B-ID-PART-001",
        verapdf_rule_id: Some("ISO_19005_1:6.7.11:2"),
        iso_clause: Some("ISO 19005-1:2005, 6.7.11"),
        strength: MappingStrength::Exact,
        reference_test: Some("part == 1"),
        notes: "Both checks require pdfaid:part to be 1.",
    },
    RuleMapping {
        local_rule_id: "PDFA1B-ID-CONFORMANCE-001",
        verapdf_rule_id: Some("ISO_19005_1:6.7.11:3"),
        iso_clause: Some("ISO 19005-1:2005, 6.7.11"),
        strength: MappingStrength::Exact,
        reference_test: Some("conformance == \"B\" || conformance == \"A\""),
        notes: "The PDF/A-1B flavour accepts a PDF/A-1A declaration because level A includes level B requirements.",
    },
    RuleMapping {
        local_rule_id: "PDFA1B-OUTPUTINTENT-001",
        verapdf_rule_id: Some("ISO_19005_1:6.2.2:1"),
